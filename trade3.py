...
if __name__ == "__main__":
    ...
    access_token = 'fdee0347844f1496c0220611445cf396b9257d14'
    server = 'demo'
    ...
    windows = 6
    price = dict()
    mylog_path = 'pytorch_log3.log'
    error_log = 'error3.log'
    img_path = 'torch_tmp3.png'
    amount = 1
    profit = 3
    max_profit = 0
    loss = 1
