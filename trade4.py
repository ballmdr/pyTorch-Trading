...
if __name__ == "__main__":
    ...
    access_token = '4be4ca2e6411953ad77071dec2b4217952072d60'
    server = 'demo'

    list1 = ['AUDCAD', 'EURGBP', 'AUDCHF']
    list2 = ['AUD/CAD', 'EUR/GBP', 'AUD/CHF']
    timeframe = 'm30'
    n_prices = 16
    windows = 6
    price = dict()
    mylog_path = 'pytorch_log4.log'
    error_log = 'error4.log'
    img_path = 'torch_tmp4.png'
    amount = 1
    profit = 3
    loss = 1
    trailing_step = 1
